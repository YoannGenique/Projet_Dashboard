...
<link href="assets/css/bootstrap.min.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark force">
        <a class="navbar-brand" href="http://127.0.0.1/ProjetDeGroupe_Dashbord/Webside_Sources/dashboard.php">Dashboard</a>
            ...
            <div class="collapse navbar-collapse float-right" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropleft">
                        ...
                        <a class="dropdown-item" href="http://127.0.0.1/ProjetDeGroupe_Dashbord/Webside_Sources/insertion.php">Ajouter un produit</a><br>
